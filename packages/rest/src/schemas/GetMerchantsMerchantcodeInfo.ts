...
import PersonComplianceMinimal from './PersonComplianceMinimal.js';
import Trademark from './Trademark.js';
import WebsiteUrl from './WebsiteUrl.js';

const GetMerchantsMerchantcodeInfo = {
  "metadata": {
    "allOf": [
      {
        "type": "object",
...
export default GetMerchantsMerchantcodeInfo
