...
export default class SDK {
  ...
  constructor() {
    this.core = new APICore(definition, 'paynl-transaction/v2.0 (api/7.0.0-beta.8)');
  }
   ...
   */
  getTransactionsTransactionid(metadata: types.GetTransactionsTransactionidMetadataParam): Promise<FetchResponse<200, types.Transaction>> {
   ...
   */
  getTransactionsTransactionidStatus(metadata: types.GetTransactionsTransactionidStatusMetadataParam): Promise<FetchResponse<200, types.TransactionStatus>> {
